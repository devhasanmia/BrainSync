                ...
                {filteredTasks.length === 0 ? (
                    ...
                    <div className="divide-y divide-gray-200 dark:divide-slate-700">
                        {filteredTasks.map((task) => (
                            <div
                                key={task.id}
                                className={`p-6 transition-colors ${task.completed
                                    ...
                                    <div className="flex items-start space-x-4 flex-1">
                                        <button
                                            ...
                                            className={`
                                                ...
                                                ${task.completed
                                                    ...
                                                    : 'bg-white dark:bg-slate-800 hover:bg-green-100 border-gray-300'
                                                }
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center space-x-3 mb-2">
                                                <h3 className={`text-lg font-semibold ${task.completed ? 'text-gray-500 line-through' : 'text-gray-800 dark:text-gray-100'}`}>
                                                    {task.title}
                                                </h3>
                                            ...
                                            {task.description && (
                                                <p className={`text-sm mb-3 ${task.completed ? 'text-gray-400' : 'text-gray-600 dark:text-gray-300'}`}>
                                                    {task.description}
                                                </p>
                                            )}
                                            ...
                                            <div className="flex items-center space-x-4 text-sm">
                                                <div className="flex items-center space-x-1">
                                                    ...
                                                    <span className={`${isOverdue(task.deadline) && !task.completed ? 'text-red-600 font-medium' : 'text-gray-500 dark:text-gray-400'}`}>
                                                ...
                                                {task.estimatedHours && (
                                                    <div className="flex items-center space-x-1">
                                                        ...
                                                        <span className="text-gray-500 dark:text-gray-400">{task.estimatedHours}h estimated</span>
                                                    </div>
                                                )}
